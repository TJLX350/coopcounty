const CACHE='coop-county-phase2-item5-30-day-overview';
const ASSETS=['./','index.html','manifest.webmanifest','assets/images/coop-county-master.png','assets/icons/icon-192.png','assets/icons/icon-512.png'];
